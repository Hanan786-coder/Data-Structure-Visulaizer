...
class MinHeap:
    ...
    def extract_min(self):
        ...
        return min_item, f"Extracted Min: '{min_item['val']}' (Prio {min_item['prio']})."
    ...
    def min_heapify(self, i):
        ...
        if l < len(self.heap) and self.heap[l]['prio'] < self.heap[smallest]['prio']:
            smallest = l
        if r < len(self.heap) and self.heap[r]['prio'] < self.heap[smallest]['prio']:
            smallest = r
...
class Visualizer:
    def __init__(self):
        ...
        self.buttons = [
            ...
            Button(420, y_op, 120, 40, "Extract Min", "EXT"),
    ...
    def draw(self):
        ...
        # 1. Header
        title_surf = font_title.render("PRIORITY QUEUE (MIN-HEAP)", True, ORANGE)
